...
#ifndef _RATMOVE_MATHGL_WXCRAFTER_BASE_CLASSES_H
#define _RATMOVE_MATHGL_WXCRAFTER_BASE_CLASSES_H
...
public:
    ...
    PlotWin* GetScrollWin() { return m_scrollWin; }
    wxPanel* GetPanelPlot() { return m_panelPlot; }
