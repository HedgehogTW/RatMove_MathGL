    ...
    : wxFrame(parent, id, title, pos, size, style)
{
    ...
    m_panelPlot = new wxPanel(this, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1,-1)), wxTAB_TRAVERSAL);
    ...
    m_scrollWin = new PlotWin(m_panelPlot, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(m_panelPlot, wxSize(600,400)), wxHSCROLL|wxVSCROLL);
    m_scrollWin->SetScrollRate(5, 5);
    
    topsizer->Add(m_scrollWin, 1, wxALL|wxEXPAND, WXC_FROM_DIP(5));
